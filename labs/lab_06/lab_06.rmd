...
**A1. It goes Carroll, Cecil, and Allegany**
...
**A2. I was interested to see Cecil has the most calls in August, but didn't really dominate the rest of the list for the most part. I was also interested in seeing Allegany had 5 months in the top 6 results. Willow Oak Ct. in Elkton MD had the highest amount of calls.**
...
A3. Zip code 21217 had the highest rate of calls. Some of the neighborhoods would be Sandtown-Winchester, Penn North, and Harlem Park. I'm not sure what in my code is incorrect but I am unable to get it to group properly by neighbourhood and zipcode, so I'm unsure of the population breakdown.
...
A4: I decided to ask what neighborhoods the older groups (over 15% of 65+) lived in and how many calls occurred in these neighborhoods, and then compared that by finding the descending count by neighborhood overall as well.

```{r}
baltimore_911_with_demographics |>
  filter(pct_pop_65 >= 15) |>
  group_by(pct_pop_65, neighborhood) |>
  summarise(count = n()) |>
  arrange(desc(count))
