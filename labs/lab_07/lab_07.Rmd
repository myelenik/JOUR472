...
**A1: Baltimore City has the lowest median estimated age.**
...
**A3 20875 has the highest, five different zip codes are tied for the lowest.**
...
md_pop_zcta <- get_acs(geography = 'zcta', year = 2019, variables = 'B09021_001', state = 'MD')
