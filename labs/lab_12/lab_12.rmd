...
**A1. The top word is failing, it looks like the top words primarily describe failing to do something for their client, failing their trust, or acting inappropriately.**
...
attorney_trigram <- md_attorney_sanctions |>
...
**A2. The top trigram was attorney trust account, which is essentially a bank account the attroney keeps with client funds safe.**
