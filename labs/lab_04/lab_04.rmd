...
#I could not figure out how to do this with datetime, but I think my method (nonefficiently) worked
```
...
media_expenses_cleaned <- read_csv("data/media_md_expenses_cleaned.csv")
...
**A2. I was unable to view the ads as Facebook said I was "misusing this feature by going too fast."**
...
**A3. I did not notice any contributions for Wes Moore or Tom Perez. I cannot see if the ads were run because of the Facebook block. The biggest recipient would be Peter Franchot, who has two committees.**

```{r}
wes_moore_expenses <- media_expenses_cleaned |>
...
**A4. This list is very different from the previous one. There are no repeats in the top five, and the top ten now contains both Moore and Perez.**

```{r}
online_spending <- media_expenses_cleaned |>
...
**A5. I was interested to find two of the three best performing candidates for governor did not invest any of their advertising money in Facebook, however, the third best performing candidate put more than anyone else.**
