...
**A1: There are 39 different payments to the PG County School system.**
...
**A2: Fiscal year 2020 had the largest total amount. I noticed that amounts generally raised from year to year as expected, however, 2016 is missing entirely. I want to know either what happened here or where the data actually is. This also makes me question the legitimacy of the rest of the data.**
...
**A3. There are 552 different vendors that appeared, however, there are clear duplicates such as "A&I INC" vs. "A&I INC.", "AEROSOL MONITORING & ANALYSIS INC" vs. "AERSOL MONITORING & ANALYSIS INC", and "AMERICAN DESIGN ASSOCIATE" vs. "AMERICAN DESIGN ASSOCIATES"**

**Some vendors contained a four digit zipcode - which is not valid. These could be removed from the dataset due to the error by filtering for zipcodes with only 5 numbers. I'm not sure how I would go about cleaning the names, but potentially using a function to find strongly similar titles and combining them or theoretically removing special characters could help consolidate them.**
...
**A4: Stem cell research has ebbed and flowed since 2009. After a sharp downturn in research from 2009 to 2010, it generally stayed above 6,000,000 until 2021 when it dropped. While the research was at its highest in the earlier years, it ha not entirely tapered off with a small uptick around 2019.**
