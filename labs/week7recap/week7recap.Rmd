...
**A1: It starts with "<https://>", making it look like a website.**
...
**A2: There are 9,975 rows (or earthquakes) in this dataset, ranging from Sept. to Oct. of 2023. It can help us learn more about where earthquakes are occurring, the frequency, magnitude, depth, etc.**
...
**A3: The deepest one was at a depth of 669.98, with a magnitude of 4.2.**
...
**A4: There are 12 earthquakes that have a magnitude larger than 6.**
...
**A5: There are 5 that fit this criteria.**
...
**A6: There are 7,412 that fit the criteria.**
...
**A8: Earthquake is the most common, followed by quarry blasts.**
...
**A9: The average depth of earthquakes is 25.28. It is a little shocking to see the mean depth is 00.00 for ice quakes.**
...
**A10: I mutated a new column by selecting the hour out of the time using a lubridate function.**
...
**A11: Used mutate to make a new column which will return "serious" or "not serious" depending on the magnitude.**
...
**A12**: Hour 2 had the most amount of serious earthquakes, while 17 had the least.
