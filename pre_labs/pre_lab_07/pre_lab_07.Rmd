...
**Answer: Howard County has the highest median household.**
...
**Answer: No. While Calvert has a stronger margin of error making it theroetically higher than Montgomery, it could easily still be lower or even almost the same.**

Is the difference between Howard and everyone else significant?

**Answer: Yes. Howard County is the highest earining county regardless of margin of error, making it fairly significant.**
...
**Answer: Baltimore City and Allegany County experienced the largest increases in median income.**
...
**Answer: We could ask if theres any correlation between income and education trends. The margin of error could make it more difficult to interpret.**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer: It is essentially counting up the amount of zip codes with under a certain enrollment rate and over a certain enrollment rate, and then creating an estimate of the household income.**
...
**Answer: We could look to see which counties have higher high school grad/college enrollment rates and do a racial breakdown to see within each county if there are areas with a higher difference.**
