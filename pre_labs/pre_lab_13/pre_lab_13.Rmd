...
**Task** Run the following code and describe the dataframe it outputs. **Answer The dataframe contains a bunch of already compiled and calulated information, like population changes and gdp growth.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer I see a slight positive relationship between 2021 gdp growth and 2021 population change, but there are many outliers.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer This plots the relationship of the money spent per student and GDP growth. This is an incredibly weak negative relationship.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer This shows the relationships between each thing, showing the actual value rather than the graph.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer This shows there likely isn't a legitiment correlation between these two values, with a very weak negative correlation value.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer This shows the relationship between these two values is not statistically significant because of the p value.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer This shows the relationship between Trump/Biden voting states and the different variables like GDP growth, spending on students, and the population growth.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer This shows the relationship between these two values is not statistically significant because of the p value.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer This shows the relationship between these two values IS statistically significant because of the p value.**
