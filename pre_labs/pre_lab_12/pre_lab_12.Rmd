...
**Answer It gives the date, url, title, and text.**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer: It consolidated all of the exact same words so there is only one of each. Different capitalization is unique.**
...
**Answer: This made everything lowercase and then pulled all the unique words, resulting in hundreds of thousands of rows.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer: It mainly shows simple words that are included in every sentence, such as "the," "and," and "to." I'd say the only ones with any interest would be U.S. and Maryland.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer: Definitely more interesting than before. It gives some insights into the content of the speeches and what the focus is on.**
...
**Task** Run the following code and describe the results. **Answer: This provides three tables for three different years to compare what the more used words were in his speeches. This can give insight into changes over time, such as the frequency of COVID in 2019 in each year, while also showing what stayed the same, like the frequency of the word "communities."**
...
**Task** Run the following code and describe the results. **Answer It resulted in the most frequent two word phrases, some of which appear to actually be three ord phrases like "covid 19" and "19 pandemic" most likely being "covid 19 pandemic."**
...
**Task** Run the following code and describe the results. **Answer: This one has a stronger focuses on areas and "project location" rather than covid 19.**
...
**Task** Run the following code and describe the results. **Answer Covid is entirely gone, focusing more on rights and health phrases instead.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer: I think "work" and "lead" being positive is interesting. Each of these could easily be used in a negative manner, such as there being a work shortage or lead poisoning.**
