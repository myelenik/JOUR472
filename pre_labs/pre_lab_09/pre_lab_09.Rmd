...
**Answer** <https://datawrapper.dwcdn.net/UFV4W/1/>
...
md_gov_county <- md_gov_county |>
  ...
  mutate(moore_votes = (moore/total_votes)*100)
...
**Answer** It made it so when hovering over each county it now displays the county name rather than the fips code and the percentage in the proper format.
...
**Answer** <https://datawrapper.dwcdn.net/bYe3L/1/>
