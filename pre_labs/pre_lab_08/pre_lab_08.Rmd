...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer: This code creates a new variable with a category named "month," groups it by the month, and then counts up all of the calls that occurred in that month. It also arranges it from greatest to least.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: It is just a blank box.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: There are bar graphs for each month adding up the amount of datapoints per month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: It was arranged in order of least to greatest, rather than in chronological order.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: It turned it into a horizontal bar chart rather than vertical.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The background is lighter than before and the font is thinner.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer: This provided white lines in the middle of each bar and and blue background behind the chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: THis gave the chart a title, legitimately named axis's, and a source at the bottom right of the chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: This shows how many calls occurred on each specific day.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a very hectic line chart that changes basically day to day.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: This attempted to calm the chart down a bit, but the bottom labels are too cluttered together to be able to read.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: This makes the label show diagonally, however, it is still not readable.**
