...
**Answer: The columns include the zipcode, colloquial names of the area, "length" of the shape, total area, and data on the shape of the area with coordinates for the actual geography.**
...
**Answer: As stated, it includes the zipcodes, colloquial names of the area, "length" of the shape, total area, and data on the shape of the area with coordinates for the actual geography.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: The output is a real Maryland map with separated counties in their actual geographical location.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: The output says that to cach the actual data, a line of code must be run.**
...
**Answer: It created a new dataset with the names of counties, geometry, classification, fips codes, and even more identifying data.**
...
**Task** Run the following code. Describe the output in the space below. **Answer This filtered it so only Maryland counties would be included.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This created a map of Maryland separated by county.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This combined the zip code map with the county map, layering the two.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This created a dataset with forclosures by zip code, then filtering it to just the month of March 2023.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This combined md_zips with the amount of foreclsures by zip for March 2023, making it possible to break down exactly where they happened.**
...
**Task** Run the following code. Describe the output in the space below. **Answe: This created a map allowing us to see where the most forclosures geographically happened in Maryland during March 2023.**
...
**Task** Run the following code. Describe the output in the space below. Be sure to input your census api key. **Answer: Okay**
...
**Task** Run the following code. Describe the output in the space below. **Answer This created a dataframe which separates Maryland by county, including the population.**
...
**Task** Run the following code. Describe the output in the space below. **Answer This added the geometry, making it mappable.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This part just displays the two datasets.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This made the dataset more readable, cleaning it up and renaming it.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This just joined the two, adding necessary identifying information to the foreclosure dataset.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This created a column with the rate of notices per population, bringing it in perspective rather than being meaningless numbers.**
...
**Task** Run the following code. Describe the output in the space below. **Answer This created a map with our data, showing exactly which areas had a higher and lower rate of foreclosures per population.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This changed around the color scheme of the map, making it more distinctly different. In my opinion, it's still a bad one.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: This changed the color scheme a bit again and made it only 4 colors rather than 5.**
