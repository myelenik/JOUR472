...
**Task** Run the following code to group and count records in the Grantee column, and filter to examine only recipients that start with W. Name a problem that you see that is preventing proper grouping. **Answer: One issue I see is incorrect spelling of certain groups. For example, there is "WASHINGTON CO COMMISSIONERS" and "WASHINGTON CO COMMISSIONE" side-by-side. There are also other instances of improper spelling/different abbreviation.**
...
**Answer: One change made was "Melwood Horticultural Training Center, Inc." was turned into "Melwood Horticultural Training Center." Also, "The Tree House Child Advocacy Center of Montgomery County MD Inc." was made into uppercase.**
...
**Answer: I'm not sure if I'm seeing it wrong, but I only see one change within the first 30 results, which is the change from "WASHINGTON ADVENTIST UNIVERSITY" to "Washington Adventist University." However, on the spreadsheet itself there is entry 6: "Washington County Museum of Fine Arts," which was changed to all caps, entry 12: "Charles County Arts Alliance Inc," which was changed to all caps and removed the Inc, and entry 13: "FAIR HILL FARM, INC." which was changed to "FAIR HILL FARM, INC"**

**I looked at the book, however the "Walden Sierra" entries just aren't there for me. I'm not sure if this is weird or expected.**
...
**Answer: Once again within the first 30 I only notice "WASHINGTON ADVENTIST UNIVERSITY" being changed to "Washington Adventist University." I do not see any actual differences between the two functions.**
...
**Added it to the pre-lab folder!**
